...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    ================================================== -->
        <meta charset="utf-8">
        <title>Alfa Strahovanie Project</title>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="portfolio-header text-center">
                        <h2>Alfa Strahovanie Project</h2>
                        <ul class="breadcrumb">
                            <li>home</li>
                            <li>portfolio</li>
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="portfolio-slider-wrapper">
                        <ul id="portfolio-slider">
                            <li><img src="images/slider/alfa1.jpg" alt="" class="img-responsive"/></li>
                            <li><img src="images/slider/alfa2.jpg" alt="" class="img-responsive"/></li>
                        </ul>
                    </div>
                </div>
             ...
             <!-- sidebar start -->
                <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12">
                    <div class="sidebar">
                        ...
                        <p><a href="https://email.wim.agency/projects/Alfa/20212021_alfa_A93_portfolio_invest_deploy/index.html" target="_blank" class="btn btn-main featured">Project Link</a></p>
                    </div>
                </div>
            </div>
